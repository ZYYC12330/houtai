# houtai/get_schooltype_dict_tree.py
# 小学
import requests
...
async def get_schooltype_dict_tree(token: str = Depends(get_token), user_ids: str = "4645a321f95b4bce992685253bf01147") -> Dict[str, Any]:
    ...
    headers = {
        ...
        "x-auth-app": "NC-CRM",
        "x-auth-nonce": "c9489d07-ef8c-4497-e96f-5e051c8da4cd",
        "x-auth-sign": "B39BE15677CEAEF1C1705D7AD5BF4B23",
