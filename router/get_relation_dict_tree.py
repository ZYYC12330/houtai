...
@router.get("/get_relation_dict_tree/")

async def get_relation_dict_tree(token: str = Depends(get_token), user_ids: str = "4645a321f95b4bce992685253bf01147") -> Dict[str, Any]:
